...
$("#productOrderList").on("click","table[id*='Header']",function(){
    // 傳值到訂單細節頁面
    var productOrderID=$(this).attr("headerID");
    sessionStorage.setItem("productOrderID",productOrderID);
    $(location).attr("href","productOrderDetail.html")
